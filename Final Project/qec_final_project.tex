...
Additionally, $\chi^{(2)}$ binomial codes are efficient in terms of photon number, but requires "channel monitoring" to identify the number of loss errors at a time step. Hence, efficiently performing this monitoring in the hardware is a requirement for this to be a viable code.
